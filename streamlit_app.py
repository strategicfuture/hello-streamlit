...
def show_results():
    ...
    if st.session_state.show_plot:
        ...
        if plot_choice == 'Use PCA to determine axes automatically':
            ...
            prompt_text = f"""I have conducted a Principal Component Analysis (PCA) and applied k-means clustering to a dataset that captures the competitive landscape of our industry, highlighting various strategic metrics. The competitors and their scores are as follows:\n\n
